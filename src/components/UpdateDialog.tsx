...
export default function UpdateDialog({ latestVersion, releaseNotes, onUpdate, onSkip }: Props) {
  return (
    <div className="fixed inset-0 z-[100] bg-black/50 flex items-center justify-center p-4">
      <div className="w-full max-w-sm bg-white dark:bg-gray-900 rounded-2xl shadow-2xl p-6 animate-scaleIn">
        {/* 圖示 */}
        ...
        {/* 更新說明 */}
        {releaseNotes && (
          <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-3 mb-5 max-h-32 overflow-y-auto">
            <p className="text-xs font-medium text-gray-700 dark:text-gray-300 mb-1">更新內容：</p>
        ...
        <div className="flex flex-col gap-2">
          ...
          <button
            onClick={onSkip}
            className="w-full py-2 text-sm font-medium text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 active:scale-95 transition-all"
          >
            稍後再說
          </button>
        </div>
