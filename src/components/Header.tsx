      ...
      <div className="max-w-7xl mx-auto px-4 py-3">
        ...
        <div className="flex items-center justify-between mb-1">
          ...
          <div className="flex items-center gap-3">
            ...
            {/* 測試警報（開發用） */}
            {!isAlarming && (
              <button onClick={simulateAlarm} className="text-xs text-orange-400 hover:text-orange-600 active:scale-95 transition-all" title="測試警報">
                🧪
              </button>
            )}
          </div>
        ...
        <div className="flex items-center justify-between text-xs text-gray-400">
          ...
          <div className="flex items-center gap-1 shrink-0">
            {/* 設定 */}
            <button onClick={() => setPage('settings')} className="p-1.5 text-gray-400 hover:text-gray-600 hover:bg-gray-100 rounded-lg active:scale-95 transition-all" title="設定">
            ...
            {/* 重新整理 */}
            <button onClick={onRefresh} disabled={isLoading} className="p-1.5 text-gray-400 hover:text-gray-600 hover:bg-gray-100 rounded-lg disabled:opacity-30 active:scale-95 transition-all" title="重新整理">
